...
export function levelup(teks, level) {
  return new Promise(async (resolve, reject) => {
    ...
    let anotations = '526567044256526567044256'; // gapake else if kadang error
    if (level > 2) anotations = '526567044256526567044256';
    if (level > 10) anotations = '526567044256526567044256';
    if (level > 50) anotations = '526567044256526567044256';
    if (level > 100) anotations = '526567044256526567044256';
