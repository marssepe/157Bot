 ...
 * @param {String} Marssepe
 */
async function sticker3(img, url, packname, Marssepe
...
async function sticker5(img, url, packname, Marssepe
 ...
 * @returns 
 */
async function addExif(webpSticker, packname, Marssepe
  const img = new webp.Image();
  const stickerPackId = crypto.randomBytes(32).toString('hex');
  const json = { 'sticker-pack-id': stickerPackId, 'sticker-pack-name': packname, 'sticker-pack-publisher': Marssepe
