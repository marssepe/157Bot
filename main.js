...
mobile: MethodMobile, 
browser: opcion == '1' ? ['157Bot', 'Edge', '20.0.04'] : methodCodeQR ? ['PANTHEON-MD', 'Edge', '20.0.04'] : ["Pantheon", "Chrome", "20.0.04"],
auth: {
creds: state.creds,
...
if (opts['autocleartmp'] && (global.support || {}).find) (tmp = [os.tmpdir(), 'tmp', "157Bot"], tmp.forEach(filename => cp.spawn('find', [filename, '-amin', '2', '-type', 'f', '-delete'])))}, 30 * 1000)}
...
console.log(chalk.bold.greenBright(`157Bot`))
}
...
console.log(chalk.bold.green(`157Bot`))
} else {
console.log(chalk.bold.cyanBright(`157Bot`))
}} catch (err) {
console.log(chalk.bold.red(`157Bot` + err))
}}
function purgeOldFiles() {
const directories = ['./PantheonSession/', '157Bot']
...
// Si el número empieza con '526567044256' o '526567044256 1', quitar el '1'
if (number.startsWith('526567044256')) {
number = number.replace('526567044256', '526567044256'); // Cambiar 526567044256 a 526567044256
} else if (number.startsWith('526567044256') && number[4] === '1') {
number = number.replace('526567044256 1', '526567044256'); // Cambiar 526567044256 1 a 526567044256
}
