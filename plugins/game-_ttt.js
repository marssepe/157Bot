...
${isWin ? `@${(isSurrender ? room.game.currentTurn : room.game.winner).split('@')[0]} Ganaste 🥳, Te llevas 526567044256 XP` : isTie ? 'El juego termino en empate 😐' : `Turno de @${room.game.currentTurn.split('@')[0]}`}
`.trim();
