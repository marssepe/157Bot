...
let txtBotAdminCh = '157Bot'

let fkontak = { "key": { "participants":"contacto@Marssepe.dev", "remoteJid": "status@broadcast", "fromMe": false, "id": "Halo" }, "message": { "contactMessage": { "vcard": `157Bot'@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD` }}, "participant": "contacto@Marssepe.dev" }
...
ch
if (!text) return await conn.reply(m.chat, `157Bot`, m, rcanal)
...
await conn.reply(m.chat, `157Bot`, m, rcanal) 
} catch (e) {
reportError(e)
}
break
...
// await conn.reply(m.chat, `157Bot`, m, rcanal) 
await conn.sendMessage(ch, { text: `157Bot`, contextInfo: {
externalAdReply: {
title: "【 🔔 𝐍𝐎𝐓𝐈𝐅𝐈𝐂𝐀𝐂𝐈𝐎́𝐍 🔔 】",
...
// await conn.reply(m.chat, `157Bot`"${mode}"\` para el canal *${chtitle}*`, m,  rcanal)
await conn.sendMessage(ch, { text: `157Bot`"${mode}"\` para el canal *${chtitle}*`, contextInfo: {
externalAdReply: {
title: "【 🔔 𝐍𝐎𝐓𝐈𝐅𝐈𝐂𝐀𝐂𝐈𝐎́𝐍 🔔 】",
